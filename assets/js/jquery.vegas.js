...
/* custom function VEGAS Home Slider */
	function loadVegas(){
		$.vegas('slideshow', {
			  backgrounds:[
				{ src:'assets/images/slider/01_b.jpg', fade:1000 },
				{ src:'assets/images/slider/02_b.jpg', fade:1000 },
				{ src:'assets/images/slider/03_b.jpg', fade:1000 },
			  ]
			})('overlay', {
			  src:'assets/images/banner_patterns/pat8.png'
			});
